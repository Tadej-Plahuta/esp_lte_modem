...
#define MODEM_ICCID_LENGTH (20)         /*!< IMEI Number Length */  //<ICCID>
...
struct modem_dce {
    ...
    char iccid[MODEM_ICCID_LENGTH + 1];                                               /*!< ICCID number */  //<ICCID>
    ...
    esp_err_t (*get_network_registration_status)(modem_dce_t *dce, uint32_t *n, uint32_t *stat);  //<GNRS>
    ...
    esp_err_t (*set_pdp_authentication_type)(modem_dce_t *dce, uint32_t cid,
                                    uint32_t auth_type, const char *user, const char *passwd); /*!< Set PDP authentication type */
